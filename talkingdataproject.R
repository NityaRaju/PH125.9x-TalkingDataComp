##Copyright Nitya Rudraraju Jan 2020
...
train <-fread('C:/Users/nitya/Downloads/talkingdata-adtracking-fraud-detection/train_sample.csv', stringsAsFactors = FALSE, data.table = FALSE)
test_valid <-fread('C:/Users/nitya/Downloads/talkingdata-adtracking-fraud-detection/test.csv', stringsAsFactors = FALSE, data.table = FALSE)
...
new_train <-fread('C:/Users/nitya/Downloads/talkingdata-adtracking-fraud-detection/train_sample.csv', 
